      ...
      <Col md={6}>
        <Row className="p-3">
          <div className="screen__context">
            ...
            <p>This is the screen which will appear during the initial app loading.</p>
          </div>
      ...
      <Col md={6}>
        <Row className="p-3">
          <div className="screen__context">
            ...
            <p>Onboarding System is not in the scope of this version. Depending on the progression of the development, I may provide prebuilt user data for testing.</p>
          </div>
